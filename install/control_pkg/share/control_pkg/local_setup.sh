...
: ${AMENT_CURRENT_PREFIX:="/home/catherineschuch/lunabotics_ros2_ws/install/control_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/control_pkg/environment/pythonpath.sh"
