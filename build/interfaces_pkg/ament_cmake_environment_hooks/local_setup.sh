...
<<<<<<< HEAD
: ${AMENT_CURRENT_PREFIX:="/ssd/home/edt/Documents/lunabotics_ros_ws/install/interfaces_pkg"}
=======
: ${AMENT_CURRENT_PREFIX:="/home/catherineschuch/lunabotics_ros2_ws/install/interfaces_pkg"}
